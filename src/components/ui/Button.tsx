...
const buttonVariants = cva(
    "inline-flex items-center justify-center h-8 px-4 py-2 whitespace-nowrap transition-all rounded-xs shadow-md ring-none " +
    "text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                brand: "bg-brand/70 hover:bg-brand border border-brand/40 text-primary disabled:opacity-70 outline-2 outline-transparent hover:outline-brand/20",
...
const Button = ({asChild, loading = false, variant, className, ...props}: ButtonProps) => {
