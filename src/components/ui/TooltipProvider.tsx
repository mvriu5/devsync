...
const useTooltip = () => {
    ...
    if (context === undefined) throw new Error("useTooltip needs to be used within a tooltip provider")
    return context
}
...
function CreateTooltip<T extends HTMLElement>(props: Omit<TooltipProps, "rect">) {
